...
* documents on disk: **52** (50 content + README + index)
* DOCUMENT-INDEX entries: **50**
* README group-table total: **50**
* engine keys in the declared architecture: **35**
* engine keys with a backing document: **32**
* docs carrying a boundary table: **8**
* boundary edges extracted: **87**
* explicit markdown links between docs: **60**
...
| --- | --- | --- | --- |
| 1 | Dangling engines — declared, no document | 3 | High |
...
flowchart LR
    ...
    E9{"Financial Modeling<br/>NO DOCUMENT"}
    E10["Marketplace"]
    E11["Capital"]
