...
check_crate crates/journey "forhemit-contracts forhemit-enginekit"
check_crate crates/package "forhemit-contracts forhemit-enginekit"

# Any crate directory not classified above fails loudly:
for crate_dir in crates/*/; do
  crate_dir=${crate_dir%/}
  case $crate_dir in
    crates/contracts | crates/enginekit | crates/audit | crates/reality | crates/destination | crates/vault | crates/scenario | crates/journey | crates/package) ;;
    *)
